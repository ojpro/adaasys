...
! function (d) {
    ...
    PIXELSIGNS.initialize = {
        ...
        general: function () {
            d(".chef-dropdown li").on("click", function (t) {
                var i = d(t.target),
                    a = i.closest(".chef-dropdown"),
                    e = a.find("label"),
                    s = e.find("span"),
                    n = a.find("input");
            ...
            }), d(".chef-select").on("click", ".placeholder", function () {
                var t = d(this).closest(".chef-select");
                t.hasClass("is-open") ? t.removeClass("is-open") : (t.addClass("is-open"), d(".chef-select.is-open").not(t).removeClass("is-open"))
            }).on("click", "ul>li", function () {
                d(this).closest(".chef-select").removeClass("is-open").find(".placeholder").text(d(this).text())
            ...
            n.on("click", function (t) {
                ...
                if (!i.hasClass("active-tab")) {
                    var a = i.data("content"),
                        ...
                        s = e.innerHeight();
                    n.removeClass("active-tab"), i.addClass("active-tab"), e.addClass("active-tab").siblings(".pix-tab-item").removeClass("active-tab"), o.animate({
                        height: s
                    }, 500)
                }
