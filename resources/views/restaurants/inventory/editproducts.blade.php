                        ...
                        <div class="widget-header">
                            <div class="row">
                                <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                    <h4>{{$selected_language->data['store_panel_inventory_products_edit'] ?? 'Edit Products'}}</h4>
                                    @if(session()->has("MSG"))
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select  class="selectpicker form-control"  name="addon_category_id[]" multiple="multiple" data-live-search="true">
