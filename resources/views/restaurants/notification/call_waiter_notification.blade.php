        ...
        <div class="modal-dialog modal-danger modal-dialog-centered modal-" role="document">
            <div class="modal-content" style="background-color: white; border-radius: 15px;">
                ...
                <div class="modal-footer">
                    <a class="btn btn-white" data-dismiss="modal" id="stopSoundCallwaiter1" >Close</a>
                    <a id="stopSoundCallwaiter3" target="_blank" href="{{route('store_admin.waiter_calls')}}" class="btn btn-primary ml-auto">View Details</a>
                </div>
            </div>
        </div>
    </div>
