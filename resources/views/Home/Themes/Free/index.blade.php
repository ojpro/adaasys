                ...
                <div class="row  rt-banner-height3 align-items-center">
                    <div class="col-lg-6">
                        <div class="rt-banner-content home-four">
                            ...
                            @if($account_info->is_playstore_enable == 1)

                            <div class="rt-button-group">
                                <a href="{{asset($account_info->playstore_link !=NULL ? $account_info->playstore_link:'#')}}" class="rt-btn rt-app-parimary wow fade-in-left" data-wow-duration="1.7s"
                                   data-wow-delay="0.6s">
                                    <div class="app-thumb">
                    ...
                    <div class="col-lg-6 d-none d-lg-block">
                        <div class="mbl-dash-mockup text-center">
                            <img src={{asset($account_info->mobile_img !=NULL ? $account_info->mobile_img:'themes/default/images/banner/mbl-mockup-1.png')}} alt="mainmockup_image"
                                 draggable="false"
                ...
                <div class="col-lg-6 rt-mb-md-30">
                    <div class="rt-flow-parent text-center rtbgprefix-contain" data-scrollax-parent="true">
                        ...
                        <div class="flow-img-item"
                            ...
                            <img src={{asset($account_info->mobile_img !=NULL ? $account_info->mobile_img:'themes/default/images/banner/mbl-mockup-1.png')}} alt=""
                    ...
                    <div class="col-lg-6 rt-mb-md-30">
                        <div class="rt-flow-parent text-center rtbgprefix-contain" data-scrollax-parent="true">
                            ...
                            <div class="flow-img-item rt-pl-80 "
                                 data-scrollax="properties: { translateX: '70px',translateY: '-30px' }">
                                <img src={{asset($account_info->qrcode_img !=NULL ? $account_info->qrcode_img:'themes/default/images/all-img/product-2.png')}} alt=""
                                     class="pulse_animation_image" width="331px" height="344px">
                            </div><!-- /.flow-img-item -->
                        </div><!-- /.rt-flow-parent -->
                    </div><!-- /.col-lg-6 -->
...
@if($account_info->is_review_enable == 1)
...
@if($account_info->is_how_its_work_enable == 1)
