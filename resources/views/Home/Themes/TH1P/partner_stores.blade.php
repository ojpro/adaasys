<div id="main_content">
    ...
    <section class="page-banner">
        <div class="container">
            <div class="page-title-wrapper">
                <h1 class="page-title">{{$selected_language->data['website_pro_partner_head1'] ?? 'Choose Your Favourite Cuisine'}}</h1>
    ...
    <section style="margin-bottom: -20px;">
        <div class="store text-center">
            <form style="display: inline; align-content: center;">
                <input type="text" placeholder="Enter Restaurant Name" id="Search" onkeyup="myFunction()"  style="max-width: 50%">

                <button class="banner-btn pix-btn btn-four btn-round">Search</button>
            </form>
        </div>
    </section>
