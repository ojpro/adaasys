            ...
            <div class="col-xs-4 col-sm-6 col-md-5 col-lg-4 col-xl-3">
                <div class="card shadow-lg">
                    ...
                    <div class="card-body px-0">
                        ...
                        <h4 class="text-center"><strong>@include('layouts.render.translation',["key" => "store_panel_qr_table_no", "default"=> "store_panel_qr"]) <span style="color:red;">{{$table->table_name}}</span></strong></h4>
